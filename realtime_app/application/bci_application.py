...
class BciApplication(Application):
    """BCI application."""
    name = Unicode("BCI", help="Name of the application.").tag(config=True)
    description = Unicode("BCI application for real-time brain-computer interface.").tag(config=True)
